...
| F25 | **Yayıncı kullanımı (uzun vade, Yiğit 2026-09-15).** Yayıncılar her yere 4K kamera koymak yerine 1080p kamerayı canlı AI ile 4K'ya çıkarır. Pazar zaten var: Fox Super Bowl 4K'yı 1080p HDR'den büyütüyor (3G-SDI 1080p60 sınırı); Beamr, TensorPix, SmallPixels (<100 ms) satıyor. Fark: yayıncı temiz kamera sinyali (sıkıştırmasız) ve düşük gecikme ister, uydurma detay (halüsinasyon) kabul etmez, 7/24 sunucu. Bizim hat sıkıştırılmış TOD + laptop + 1-2 sn gecikme. | Fikir gerçek ihtiyaca denk geliyor. Şimdilik yön değiştirmez; açık kaynak tüketici GPU projesi portfolyo ve kanıt olur. | uzun vade |
| F26 | **Gerçek TOD yumuşaklığını öğren (Yiğit gözlemi 2026-09-16).** Logo keskin, kamera görüntüsü 1080p gibi değil. Simülatör temiz 4K'dan keskin 1080p üretiyor, gerçek yayın daha yumuşak. Canlı TOD'da etkili çözünürlüğü **sadece sayı olarak** ölç (frekans spektrumu, logo hariç), simülatöre ön küçültme + bulanıklık + çift sıkıştırma ekleyip aynı sayıya getir, modeli x2 + netleştirme için yeniden eğit. Grafikler zaten keskin, dokunma (F7). | Model şu an kaynağın keskin olduğunu varsayıyor, çamuru olduğu gibi büyütüyor. Gözle görülen asıl fark burada. | aday |
